...
//当选中tab下的panel时，增加选中样式并设定选中panel标题颜色的文字颜色
//_349.tab.addClass("tabs-selected").find("span").css("color","#0A6A9D");
//给选中的li增加三角箭头
//_349.tab.append("<div class='tabs-arrow' style='left:20px'><b></b></div>");
//设定三角箭头所在DIV相对位置
//_349.tab.find(".tabs-arrow").css("left",(tab.find('.tabs-inner').width()-32)/2-5);
...
//---------------------------------------------------------------------
//var cur_li = _34d.tab;
//cur_li.removeClass("tabs-selected").find("span").css("color","#777777"); 
//cur_li.find(".tabs-arrow").remove();
//---------------------------------------------------------------------
...
(function(){
if(_48f.validating && !_48f.options.blur ){
...
$.fn.validatebox.defaults={required:false,blur:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"该输入项为必填项.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_48d,blur:_491,mouseenter:_494,mouseleave:_497,click:function(e){
var t=$(e.data.target);
...
},message:"请输入一个合法的email地址."},url:{validator:function(_4bc){
...
},message:"请输入一个合法的URL地址."},length:{validator:function(_4bd,_4be){
var len=$.trim(_4bd).length;
return len>=_4be[0]&&len<=_4be[1];
},message:"请输入一个 {0} 到 {1}长度的值."},remote:{validator:function(_4bf,_4c0){
var data={};
data[_4c0[1]]=_4bf;
var _4c1=$.ajax({url:_4c0[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _4c1=="true";
},message:"请修正这个输入项."}},onBeforeValidate:function(){
