    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel', models.DecimalField(blank=True, decimal_places=0, max_digits=11, null=True, verbose_name='电话')),
                ('group', models.CharField(blank=True, max_length=500, null=True, verbose_name='公司名')),
